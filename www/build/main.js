        ...
        storage.get('childdetail').then(function (val) {
            ...
            if (val == null) {
                ...
                var read = val.map(function (data) {
                    _this.childdetail.push({ 'firstname': data.firstname, 'lastname': data.lastname, 'phone': data.phone, 'email': data.email, 'dob': data.dob, 'gender': data.gender, 'institution': data.institution, 'fb': data.fb, 'instagram': data.instagram, 'snapchat': data.snapchat, 'street': data.street, 'city': data.city, 'zip': data.zip, 'country': data.country, 'state': data.state, 'ethnicity': data.ethnicity });
                });
            }
        });
    }
...
var ChildinfoPage = (function () {
    ...
    ChildinfoPage.prototype.submit = function () {
        if (this.firstname == '') {
            ...
            this.childdetail.push({ 'firstname': this.firstname, 'lastname': this.lastname, 'phone': this.phone, 'email': this.email, 'dob': this.dob, 'gender': this.gender, 'institution': this.institution, 'fb': this.fb, 'instagram': this.instagram, 'snapchat': this.snapchat, 'street': this.street, 'city': this.city, 'zip': this.zip, 'country': this.country, 'state': this.state, 'ethnicity': this.ethnicity });
            var toast = this.toastCtrl.create({
...
var ChildinfoeditPage = (function () {
    function ChildinfoeditPage(storage, toastCtrl, navCtrl, navParams) {
        ...
        this.ethnicity = this.data.ethnicity;
